...
/**
 * Servlet implementation class SubmissionsIndexServlet
 */
@WebServlet("/submissions/index")
public class SubmissionsIndexServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public SubmissionsIndexServlet() {
        super();
    ...
    protected String createMonthLink(int year, int month){
        ...
        sb.append("<a href=\"/daily_report_system/submissions/index?YEAR=");
        sb.append(year);
        sb.append("&MONTH=");
        sb.append(month - 1);
